...
namespace TicketStore.Services.EventCatalog.DbContexts
{
    public class EventCatalogDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/TicketStore/banjo.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/TicketStore/michael.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/TicketStore/dj.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/TicketStore/guitar.jpg",
                CategoryId = concertGuid
            });
            ...
            modelBuilder.Entity<Event>().HasData(new Event
            {
                ...
                ImageUrl = "https://gillcleerenpluralsight.blob.core.windows.net/files/TicketStore/conf.jpg",
                CategoryId = conferenceGuid
            });
