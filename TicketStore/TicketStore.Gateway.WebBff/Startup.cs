using AutoMapper;
using TicketStore.Gateway.WebBff.Services;
...
using System;
using TicketStore.Gateway.WebBff.Url;

namespace TicketStore.Gateway.WebBff
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "TicketStore Gateway BFF for Web API", Version = "v1" });
            });
        }
